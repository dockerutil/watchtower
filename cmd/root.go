...
func NewRootCommand() *cobra.Command {
	...
	More information available at https://github.com/dockerutil/watchtower/.
	`,
		Run:    Run,
		PreRun: PreRun,
